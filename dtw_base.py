...
# def draw_path(PATH, Rdata, pred):
#     axis = np.arange(0, len(PATH[1, :]), 1)
#     plt.plot(axis, Rdata[PATH[1, :]], label='original')
#     plt.plot(axis, pred[PATH[0, :]], label='predict')
#     plt.legend()
#     plt.show()
#
# def draw_path_o(Rdata, pred):
#     axis = np.arange(0, len(Rdata), 1)
#     plt.plot(axis, Rdata, label='original')
#     plt.plot(axis, pred, label='predict')
#     plt.legend()
#     plt.show()
